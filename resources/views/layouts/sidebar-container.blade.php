@php
    $isMasterAdmin = \Auth::user()->level == 'admin';
    $isMasterUser = \Auth::user()->level == 'user';
@endphp
...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                {{-- <div class="menu-item pt-5">
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Configuration Data</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if (Route::currentRouteName() == 'auth.configuration-data.readiness.index') active @endif" href="{{ route('auth.configuration-data.readiness.index') }}">
                        <span class="menu-icon">
                        ...
                        <span class="menu-title">Readiness Status</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link @if (Route::currentRouteName() == 'auth.configuration-data.operation.index') active @endif" href="{{ route('auth.configuration-data.operation.index') }}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-3">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">Operation Status</span>
                    </a>
                </div> --}}
                @if ($isMasterAdmin)
                    <div class="menu-item pt-5">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'siswa.index') active @endif" href="{{ route('admin.siswa') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'admin.guru') active @endif" href="{{ route('admin.guru') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'admin.ujian') active @endif" href="{{ route('admin.ujian') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.3" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" fill="currentColor" />
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'admin.mapel') active @endif" href="{{ route('admin.mapel') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'admin.kelas') active @endif" href="{{ route('admin.kelas') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20 7H3C2.4 7 2 6.6 2 6V3C2 2.4 2.4 2 3 2H20C20.6 2 21 2.4 21 3V6C21 6.6 20.6 7 20 7ZM7 9H3C2.4 9 2 9.4 2 10V20C2 20.6 2.4 21 3 21H7C7.6 21 8 20.6 8 20V10C8 9.4 7.6 9 7 9Z" fill="currentColor" />
                     ...
                     <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'admin.soal') active @endif" href="{{ route('admin.soal') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.3" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" fill="currentColor" />
                ...
                @if ($isMasterUser)
                    <div class="menu-item pt-5">
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">Kursus yg diikuti</span>
                        </div>
                    </div>
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'tryout') active @endif" href="{{ route('tryout') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20 19.725V18.725C20 18.125 19.6 17.725 19 17.725H5C4.4 17.725 4 18.125 4 18.725V19.725H3C2.4 19.725 2 20.125 2 20.725V21.725H22V20.725C22 20.125 21.6 19.725 21 19.725H20Z" fill="currentColor" />
                            ...
                            <span class="menu-title">Try out</span>
                        </a>
                    </div>
                    {{-- <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'auth.master-data.sub_unit.index') active @endif" href="">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.3" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" fill="currentColor" />
                    ...
                    <div class="menu-item">
                        <a class="menu-link @if (Route::currentRouteName() == 'auth.master-data.equipment.index') active @endif" href="">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20 7H3C2.4 7 2 6.6 2 6V3C2 2.4 2.4 2 3 2H20C20.6 2 21 2.4 21 3V6C21 6.6 20.6 7 20 7ZM7 9H3C2.4 9 2 9.4 2 10V20C2 20.6 2.4 21 3 21H7C7.6 21 8 20.6 8 20V10C8 9.4 7.6 9 7 9Z" fill="currentColor" />
                            ...
                            <span class="menu-title">Bahasa Inggris</span>
                        </a>
                    </div> --}}
    ...
    <!-- <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click">
            <span class="btn-label">&copy; 2022 - SADA TECHNOLOGY</span>
        </a>
    </div> -->
</div>
